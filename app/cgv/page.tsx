...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "La garantie légale de conformité s'applique indépendamment de toute garantie commerciale et ne peut être ni écartée, ni restreinte par une clause contractuelle.",
