...
/**
 * Les formateurs vivent désormais dans `lib/format.ts` — `lib/offering.ts` en
 * a besoin et ne peut pas importer ce module sans créer un cycle. Ils sont
 * réexportés ici pour que les imports existants continuent de fonctionner.
 */
export { formatDecimal, formatDuration, formatNumber } from "@/lib/format";
