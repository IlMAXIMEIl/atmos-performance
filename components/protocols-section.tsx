...
const PROTOCOLS: Protocol[] = [
  {
    ...
    axis: [2100, 2600],
    theme: {
      border: "hover:border-band-lhtl/40",
      glow: "bg-[radial-gradient(circle_at_50%_0%,var(--band-lhtl-glow),transparent_70%)]",
      badge: "border-band-lhtl/40 bg-band-lhtl/[0.07] text-band-lhtl-ink",
      icon: "text-band-lhtl-ink",
      title: "text-band-lhtl-ink",
      segment: "bg-band-lhtl",
    },
  },
  {
    id: "entrainement",
    ...
    axis: [2500, 3500],
    theme: {
      border: "hover:border-band-iht/35",
      glow: "bg-[radial-gradient(circle_at_50%_0%,var(--band-iht-glow),transparent_70%)]",
      badge: "border-band-iht/25 bg-band-iht/[0.07] text-band-iht-ink",
      icon: "text-band-iht-ink",
      title: "text-band-iht-ink",
      segment: "bg-band-iht",
    },
  },
  {
    ...
    axis: [3500, 5000],
    theme: {
      border: "hover:border-band-ihe/35",
      glow: "bg-[radial-gradient(circle_at_50%_0%,var(--band-ihe-glow),transparent_70%)]",
      badge: "border-band-ihe/25 bg-band-ihe/[0.07] text-band-ihe-ink",
      icon: "text-band-ihe-ink",
      title: "text-band-ihe-ink",
      segment: "bg-band-ihe",
    },
  },
];
